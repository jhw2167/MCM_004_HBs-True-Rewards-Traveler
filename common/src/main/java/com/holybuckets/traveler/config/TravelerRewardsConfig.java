...
public class TravelerRewardsConfig {
    ...
    public static class SimpleRewardsConfig {
        ...
        public Set<String> fabricationRitualBlocksWhitelist = new HashSet<>(Set.of(
            /*Surface cave blocks*/ "minecraft:dirt", "minecraft:grass_block", "minecraft:cobblestone", "minecraft:stone", "minecraft:gravel",
            /*Dirts*/ "minecraft:coarse_dirt", "minecraft:podzol", "minecraft:mud", "minecraft:sand", "minecraft:red_sand", "minecraft:sandstone", "minecraft:red_sandstone", "minecraft:soul_sand", "minecraft:mycelium",
            ...
            /*Logs*/ "minecraft:mangrove_log", "minecraft:cherry_log", "minecraft:bamboo_block", "minecraft:crimson_stem", "minecraft:warped_stem",
            /*Planks*/ "minecraft:mangrove_planks", "minecraft:cherry_planks", "minecraft:bamboo_planks", "minecraft:crimson_planks", "minecraft:warped_planks",
